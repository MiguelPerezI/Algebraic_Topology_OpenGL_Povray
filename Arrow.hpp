...
class SpaceCurve {
	public:
		...
		void initCortinaBase(int n, double width);
		void initCortinaHead(int n, double width);
		void initSpaceCurveParabola(int n, double v0, double g, double H, double alpha, int eje, double width);
		void initCurveList();
};
